...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The ASCII table equivalent of marsWeightInt is: " + c);

        //assign the value of performing some arithmetical operation on the char character to the new int variable
        int exampleOfMathOnChar = c * c;
        System.out.println("An example of arithmetical operation on the char type: " + exampleOfMathOnChar);
    }
}
